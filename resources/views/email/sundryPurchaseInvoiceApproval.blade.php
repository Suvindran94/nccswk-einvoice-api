                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            style=" font-family: Arial, Helvetica, sans-serif; box-sizing: border-box;  font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            A <b>Sundry Purchase Invoice</b> has been
                                            <b>{{ $sundryPurchaseInvoiceHeader->SPI_APV_STATUS == 'A' ? 'Approved' : 'Rejected' }}</b>.
                                        </p>
                                        <p
                                            style=" font-family: Arial, Helvetica, sans-serif; box-sizing: border-box;  font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Detail as below:</p>
                                        <table class="panel" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td style=" font-family: Arial, Helvetica, sans-serif; width:68%;">
                                                    <b>{{ $sundryPurchaseInvoiceHeader->SPI_ID }}</b>
                                                </td>
                                            </tr>
                                        </table>
                                        <table class="panel" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td style=" font-family: Arial, Helvetica, sans-serif; width:68%;">
                                                    ...
                                                    <b>{{ $sundryPurchaseInvoiceHeader->SPI_REF }}</b>
                                        ...
                                        <table class="panel" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td style=" font-family: Arial, Helvetica, sans-serif; width:68%;">
                                                    ...
                                                    <b>{{ $sundryPurchaseInvoiceHeader->SPI_APV_REMARK }}</b>
                                        ...
                                        <table class="panel" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style=" font-family: Arial, Helvetica, sans-serif; width:30%;">
                                                    {{ $sundryPurchaseInvoiceHeader->SPI_APV_STATUS == 'A' ? 'Approved' : 'Rejected' }}
                                                    by
                                                </td>
                                                <td>
                                                    :
                                                ...
                                                <td style=" font-family: Arial, Helvetica, sans-serif; width:68%;">
                                                    <b>{{ $sundryPurchaseInvoiceHeader->approver->fname }}
                                                        ({{ $sundryPurchaseInvoiceHeader->SPI_APV_DATE ? Carbon\Carbon::parse($sundryPurchaseInvoiceHeader->SPI_APV_DATE)->format('d M Y') : 'N/A' }})</b>
                                                </td>
                                            </tr>
                                        </table>
